...
def randomly_generated_location(vacation_locations):
    selected_location = random.choice(vacation_locations)
    return selected_location

def randomly_generated_restaurant(restaurants):
    selected_restaurant = random.choice(restaurants)
    return selected_restaurant

def randomly_generated_transportation(transportation_list):
    selected_transportation = random.choice(transportation_list)
    return selected_transportation

def randomly_generated_entertainment(entertainment_list):
...
# def run_day_trip_generator(vacation_locations, restaurants, transportation_list, entertainment_list):
#     greeting()
#     selected_location = randomly_generated_location(vacation_locations)
#     selected_restaurant = randomly_generated_restaurant(restaurants)
#     selected_transportation = randomly_generated_transportation(transportation_list)
#     selected_entertainment = randomly_generated_entertainment(entertainment_list)
#     day_trip()
